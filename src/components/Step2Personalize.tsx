...
export const Step2Personalize: React.FC<Step2PersonalizeProps> = ({
  ...
  const isBinnenZoom = s.binnenZoom !== null;

  return (
    <div className="flex flex-col min-h-screen pb-28 bg-[var(--background)]">
      {/* Top Header Bar */}
      <div className="px-5 pt-5 pb-1 flex items-center justify-between z-20">
        <button
          type="button"
          onClick={onBack}
        ...
        <button
          ...
          className={`px-4 py-2 rounded-[999px] text-[0.8125rem] font-medium transition-all cursor-pointer ${
            s.locked
              ? 'bg-[#f0f1f4] text-[#1a1a1e] font-bold tracking-wide border border-transparent'
      ...
      <div className="flex justify-center mt-3 px-5 z-20">
      ...
      {/* Inside Spread Zoom Back Button */}
      {s.side === 'binnen' && isBinnenZoom && (
        ...
        {s.side === 'voor' && (
          <div className="flex gap-2.5">
            <button
              ...
              className={`flex-1 h-[52px] rounded-[999px] bg-[var(--background)] border border-[var(--border-strong)] text-[0.9375rem] font-medium text-[var(--foreground)] transition-all cursor-pointer shadow-sm ${
                s.locked ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#f0f1f4]'
              }`}
            >
              Stijl
            </button>
          ...
          <div className="flex gap-2.5">
            {s.binnenZoom === 'links' && (
              <button
                ...
                className={`w-full h-[52px] rounded-[999px] bg-[var(--background)] border border-[var(--border-strong)] text-[0.9375rem] font-medium text-[var(--foreground)] transition-all cursor-pointer shadow-sm ${
                  s.locked ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#f0f1f4]'
                }`}
              >
                Tekst
